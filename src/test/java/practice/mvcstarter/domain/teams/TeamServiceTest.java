...
public class TeamServiceTest {
    ...
    @Test
    @DisplayName("[팀 생성] 매개변수가 null 인 경우")
    ...
    @Test
    @DisplayName("[팀 생성] dto validation 미통과")
    ...
    @Test
    @DisplayName("[팀 생성] dto validation 통과")
    ...
    @Test
    @DisplayName("[팀 단건 조회] 매개변수가 null 인 경우")
    ...
    @Test
    @DisplayName("[팀 단건 조회] 매개변수가 invalid 인 경우")
    ...
    @Test
    @DisplayName("[팀 단건 조회] 매개변수가 정상 인 경우")
    void getSingleTeam_whenValidParam_thenReturnTeamDto() {
        /* given */
        Team givenTeam = new Team(TEAM_NAME);
    ...
    @Test
    @DisplayName("[팀 갱신] 매개변수가 null 인 경우")
    ...
    @Test
    @DisplayName("[팀 갱신] 매개변수가 invalid 인 경우")
    ...
    @Test
    @DisplayName("[팀 갱신] 매개변수가 정상 인 경우")
    ...
    @Test
    @DisplayName("[팀 삭제] 매개변수가 null 인 경우")
    ...
    @Test
    @DisplayName("[팀 삭제] 매개변수가 invalid 인 경우")
    ...
    @Test
    @DisplayName("[팀 삭제] 매개변수가 정상 인 경우")
